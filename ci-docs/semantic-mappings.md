...
**Семантические сопоставления в настоящее время включены для сред, основанных на организациях**. *ContactProfile* — единственный тип семантического сопоставления, доступный в настоящее время в Customer Insights.
...
1. [Определите семантическое сопоставление сущностей *ContactProfile*](#define-a-contactprofile-semantic-entity-mapping) и выполните семантическое сопоставление.
...
1. После запуска сопоставления действий на уровне контакта выберите **Клиенты**. Действия на уровне контактов отображаться на временной шкале ваших клиентов.
...
Временная шкала активности для ваших клиентов включает их идентификаторы или имена, в зависимости от конфигурации *ContactProfile*, для действий, которые они предпринимали. Отфильтруйте действия на временной шкале по контактам для просмотра конкретных контактов, которые вам интересны. Чтобы просмотреть все действия, которые не назначены ни одному конкретному контакту, выберите **Действия не сопоставлены с контактом**.
