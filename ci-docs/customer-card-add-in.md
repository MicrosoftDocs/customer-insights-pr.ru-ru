...
- Некоторые данные и элементы управления доступны только в средах определенных типов. Конфигурация надстройки сообщит вам, если элемент управления недоступен из-за выбранного типа среды. Эта ошибка будет отображаться в элементе управления при его отрисовке. Подробнее о [вариантах использования среды](work-with-business-accounts.md).
- Каждый элемент управления надстройки основан на определенных данных в Customer Insights.
