---
title: Предлагаемые сегменты (предварительная версия)
...
Как пользователь Customer Insights, вы, вероятно, имеете ряд [созданных мер](measures.md), которые помогают отслеживать ваши ключевые показатели эффективности (КПЭ). Важно понимать, как определенные атрибуты влияют на эти KPI, чтобы создавать сегменты и проводить целенаправленную кампанию.   
