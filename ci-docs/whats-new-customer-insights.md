...
Для получения дополнительной информации см. раздел [Используйте частную ссылку в Customer Insights](security-overview.md#private-links-tab).
