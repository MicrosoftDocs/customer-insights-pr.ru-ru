...
Чтобы [запланировать автоматическое обновление](system.md#schedule-tab), перейдите к пункту **Администрирование** > **Система** > **Расписание**. Применяются следующие правила:
