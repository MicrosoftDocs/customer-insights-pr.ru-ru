...
1. Сопоставьте семантические атрибуты с полями, которые необходимы для запуска модели. Если поля ниже не заполнены, настройте связь между сущностью истории покупок и сущностью *Клиент*.
...
### <a name="provide-an-optional-list-of-benchmark-accounts-business-accounts-only"></a>Предоставьте необязательный список эталонных организаций (только для организаций)
