...
- Предлагаемые характеристики данных:
    - Достаточно исторических данных: данные о транзакциях, по крайней мере, в два раза больше выбранного временного окна. Желательно, чтобы данные о подписке составляли два-три года. 
