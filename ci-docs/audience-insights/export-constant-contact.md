...
---
# <a name="export-segment-lists-to-constant-contact-preview"></a>Экспорт списков сегментов в Constant Contact (предварительная версия)
...
1. Выберите **Аутентификация в AdRoll** и укажите свои учетные данные администратора для Constant Contact. 
