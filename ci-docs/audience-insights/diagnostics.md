...
- Необходимо иметь разрешения [администратора](permissions.md#administrator) в Customer Insights.
...
| `properties.operationType`                   | Да      | Да  | Идентификатор операции, см. раздел [Operation types].(#operation-types)                                                                                                                                                                                       |
| `properties.tasksCount`                      | Да      | Нет   | Только для рабочих процессов. Количество задач, активируемых рабочим процессом.                                                                                                                                                                                                       |
