...
---
# <a name="overview-about-data-sources"></a>Обзор источников данных
...
|Не пройдено     |При приеме данных возникли ошибки.         |

Выберите **Обновить статус** для просмотра дополнительных сведений о состоянии обновления, включая сведения об ошибках и обновления последующих процессов.
