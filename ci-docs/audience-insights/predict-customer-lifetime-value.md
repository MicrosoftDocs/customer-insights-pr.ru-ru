...
> [!NOTE]
> - Для модели требуется история транзакций ваших клиентов. В настоящее время можно настроить только одну сущность истории транзакций. Если существует несколько сущностей покупки/транзакции, можно объединить их в запрос Power Query перед приемом данных.
