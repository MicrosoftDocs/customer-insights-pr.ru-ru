...
Визуализатор отношений показывает сетевую диаграмму существующих отношений между подключенными сущностями и их кратность.
...
Системные и пользовательские отношения используются для [создания сегментов](segments.md) на основе нескольких источников данных, которые больше не обособлены.
