...
Перейдите на **Объединить** > **Соответствие** и выберите **Задать порядок**, чтобы начать фазу соответствия.
...
1. Эта запись победителя затем передается для соответствия между сущностями.
