...
-   У вас есть [одобренный токен разработчика Google Рекламы](https://developers.google.com/google-ads/api/docs/first-call/dev-token) 
...
1. В поле **Подключение для экспорта** выберите подключение из раздела Google Реклама. Если вы не видите название этого раздела, вам не доступны подключения этого типа.
