...
1. Проверьте конфигурацию приема данных. Отредактируйте источник данных для системы Dynamics 365, который содержит GUID идентификатора контакта. Если GUID идентификатора контакта отображается прописными буквами в редакторе Power Query, попробуйте следующее: 
...
После завершения полного обновления элементы управления надстройки карточки клиента должны отображать ожидаемые данные. 
