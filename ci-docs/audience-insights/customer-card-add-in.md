...
- Чтобы ваши данные Dynamics 365 сопоставлялись профилям клиентов в аналитике аудитории, они должны быть [приняты из приложения Dynamics 365 с помощью соединителя Common Data Service](connect-power-query.md).
