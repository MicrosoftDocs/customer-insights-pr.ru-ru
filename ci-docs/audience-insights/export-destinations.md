...
- **Экспорт исходящих данных** позволяет экспортировать сущности любого типа, доступные в аналитике аудитории. Сущности, выбранные для экспорта, экспортируются со всеми полями данных, метаданными, схемами и сведениями сопоставления. 
- **Сегментный экспорт** позволяет экспортировать сущности сегмента из аналитики аудитории. Сегменты представляют собой список профилей клиентов. При настройке экспорта вы выбираете поля включенных данных в зависимости от целевой системы, в которую вы экспортируете данные. 

### <a name="export-segments"></a>Экспортировать сегменты

**Экспорт сегментов в средах для организаций (B2B) или частных клиентов (B2C)**  
Большинство вариантов экспорта поддерживают оба типа сред. Экспорт сегментов в различные целевые системы предъявляет особые требования. Как правило, участник сегмента, профиль клиента содержит контактную информацию. Хотя это обычно относится к сегментам, основанным на частных клиентах (B2C), это не обязательно относится к сегментам, основанным на организациях (B2B). 

**Сегментные экспортные среды для организации (B2B)**  
...
**Сегментный экспорт в средах для частных клиентов (B2C)**  
