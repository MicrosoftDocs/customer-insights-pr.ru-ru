...
1. В шаге **данные о деятельности** введите следующие сведения:
   ...
   - **Первичный ключ**: выберите поле, которое однозначно идентифицирует запись. Оно не должно содержать никаких повторяющихся значений, пустых значений или отсутствующих значений.
     ...
     > [!NOTE]
     > Первичный ключ для каждой строки должен оставаться согласованным при обновлениях источника данных. Если первичный ключ для строки обновляется при обновлении источника данных, он создает дубликаты в выходной сущности действия. 
